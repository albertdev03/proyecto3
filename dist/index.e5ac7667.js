...
},{"bootstrap/dist/css/bootstrap.min.css":"i5LP7","bootstrap/dist/js/bootstrap.bundle.min.js":"gCRej"}],"i5LP7":[function() {},{}],"gCRej":[function(require,module,exports) {
/*!
  ...
  */ !function(t, e) {
    ...
    N.on(document, Ls, zs, function(t) {
        [
            "A",
            "AREA"
        ].includes(this.tagName) && t.preventDefault(), l(this) || Vs.getOrCreateInstance(this).show();
    }), N.on(window, Ds, ()=>{
        for (const t of z.find(qs))Vs.getOrCreateInstance(t);
    }), m(Vs);
    const Ks = ".bs.toast", Qs = `mouseover${Ks}`, Xs = `mouseout${Ks}`, Ys = `focusin${Ks}`, Us = `focusout${Ks}`, Gs = `hide${Ks}`, Js = `hidden${Ks}`, Zs = `show${Ks}`, to = `shown${Ks}`, eo = "hide", io = "show", no = "showing", so = {
        animation: "boolean",
        autohide: "boolean",
        delay: "number"
    }, oo = {
...
},{}]},["glH8k","aitAD"], "aitAD", "parcelRequire0e46")
